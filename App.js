...
const RestaurantCard = (props) =>{
    ...
    return(
        <div className='res-card' style={{background:"#f0f0f0"}}>
            ...
            className='res-logo'
            alt='meghana food '
            src={'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/FOOD_CATALOG/IMAGES/CMS/2024/8/25/62013b77-885c-472b-9807-f4838727cd67_ce5495b7-2334-4186-b0c7-42bf970078ad.JPG'}
            />
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
...
// === End of RestaurantCard component === //
    ...
    return (
        <div className='body'>
            ...
            <div className='res-container'>
                ...
                <RestaurantCard esData =  {resList[1]}/>
